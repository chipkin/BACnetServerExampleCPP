...
bool CallbackAcknowledgeAlarm(const uint32_t deviceInstance, const uint32_t acknowledgingProcessIdentifier, const uint16_t eventObjectType, const uint32_t eventObjectInstance, const uint16_t eventStateAcknowledged, const uint8_t eventTimeStampYear, const uint8_t eventTimeStampMonth, const uint8_t eventTimeStampDay, const uint8_t eventTimeStampWeekday, const uint8_t eventTimeStampHour, const uint8_t eventTimeStampMinute, const uint8_t eventTimeStampSecond, const uint8_t eventTimeStampHundrethSecond, const char *acknowledgementSource, const uint32_t acknowledgementSourceLength, const uint8_t acknowledgementSourceEncoding, const bool timeOfAcknowledgementIsTime, const bool timeOfAcknowledgementIsSequenceNumber, const bool timeOfAcknowledgementIsDateTime, const uint8_t timeOfAcknowledgementYear, const uint8_t timeOfAcknowledgementMonth, const uint8_t timeOfAcknowledgementDay, const uint8_t timeOfAcknowledgementWeekday, const uint8_t timeOfAcknowledgementHour, const uint8_t timeOfAcknowledgementMinute, const uint8_t timeOfAcknowledgementSecond, const uint8_t timeOfAcknowledgementHundrethSecond, const uint16_t timeOfAcknowledgementSequenceNumber, uint32_t *errorCode);
...
int main(int argc, char **argv) {
    ...
    std::cout << "https://github.com/chipkin/BACnetServerExampleCPP" << std::endl
              << std::endl;
    ...
    // Alarms and Events Callback Function
    fpRegisterCallbackAcknowledgeAlarm(CallbackAcknowledgeAlarm);
...
bool DoUserInput() {
    ...
    case 'f': {
        ...
        std::cout << "Sending Register Foreign Device to" << g_database.networkPort.FdBbmdAddressHostIp[0] << "." << g_database.networkPort.FdBbmdAddressHostIp[1] << "." << g_database.networkPort.FdBbmdAddressHostIp[2] << "." << g_database.networkPort.FdBbmdAddressHostIp[3] << ":" << g_database.networkPort.FdBbmdAddressPort << std::endl;
    ...
    case 'm': {
        ...
        std::cout << "Sending text message to" << g_database.networkPort.FdBbmdAddressHostIp[0] << "." << g_database.networkPort.FdBbmdAddressHostIp[1] << "." << g_database.networkPort.FdBbmdAddressHostIp[2] << "." << g_database.networkPort.FdBbmdAddressHostIp[3] << ":" << g_database.networkPort.FdBbmdAddressPort << std::endl;
...
bool CallbackAcknowledgeAlarm(
    ...
    const uint16_t timeOfAcknowledgementSequenceNumber,
    uint32_t *errorCode) {
		// This function should be used to validate the acknowledgingSource, but we just print out the variables in this example
		std::cout << "CallbackAcknowledgeAlarm: " <<
					 "\n    deviceInstance: " << deviceInstance <<
					 "\n    acknowledgingProcessIdentifier: " << acknowledgingProcessIdentifier <<
					 "\n    eventObjectType: " << eventObjectType <<
					 "\n    eventObjectInstance: " << eventObjectInstance <<
					 "\n    eventStateAcknowledged: " << eventStateAcknowledged <<
					 "\n    eventTimeStamp: " << eventTimeStampYear << "/" << eventTimeStampMonth << "/" << eventTimeStampDay << " " << eventTimeStampHour << ":" << eventTimeStampMinute << ":" << eventTimeStampSecond <<
					 "\n    timeOfAcknowledgement " << timeOfAcknowledgementYear << "/" << timeOfAcknowledgementMonth << "/" << timeOfAcknowledgementDay << " " << timeOfAcknowledgementHour << ":" << timeOfAcknowledgementMinute << ":" << timeOfAcknowledgementSecond <<
					 "\n    acknowledgementSource " << std::string(acknowledgementSource, acknowledgementSourceLength) << 
					 "\n    timeOfAcknowledgementIsTime: " << timeOfAcknowledgementIsTime <<
					 "\n    timeOfAcknowledgementIsSequenceNumber: " << timeOfAcknowledgementIsSequenceNumber <<
					 "\n    timeOfAcknowledgementIsDateTime: " << timeOfAcknowledgementIsDateTime <<
...
bool HookTextMessage(const uint32_t sourceDeviceIdentifier, const bool useMessageClass, const uint32_t messageClassUnsigned, const char *messageClassString, const uint32_t messageClassStringLength, const uint8_t messagePriority, const char *message, const uint32_t messageLength, const uint8_t *connectionString, const uint8_t connectionStringLength, const uint8_t networkType, const uint16_t sourceNetwork, const uint8_t *sourceAddress, const uint8_t sourceAddressLength, uint16_t *errorClass, uint16_t *errorCode) {
    ...
    if (sourceDeviceIdentifier == expectedSourceDeviceIdentifier &&
        ...
        std::cout << std::endl
                  << "Received text message request meant for us to perform some logic: " << message << std::endl;
