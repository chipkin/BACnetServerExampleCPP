...
class ExampleNotificationClass : public ExampleDatabaseBaseObject {
public:
    uint8_t toOffNormalPriority;
    uint8_t toFaultPriority;
    uint8_t toNormalPriority;
    bool toOffNormalAckRequired;
    bool toFaultAckRequired;
    bool toNormalAckRequired;
};

class ExampleNotificationClassRecipient {
public:
    uint8_t validDays;
    uint8_t fromTimeHour;
    uint8_t fromTimeMinute;
    uint8_t fromTimeSecond;
    uint8_t fromTimeHundrethSecond;
    uint8_t toTimeHour;
    uint8_t toTimeMinute;
    uint8_t toTimeSecond;
    uint8_t toTimeHundrethSecond;
    uint32_t processIdentifier;
    bool issueConfirmedNotifications;
    bool transitionToOffNormal;
    bool transitionToFault;
    bool transitionToNormal;
    bool useRecipientDeviceChoice;
...
public:
    ...
    ExampleNotificationClass notificationClass;
    ExampleNotificationClassRecipient notificationClassRecipient;
